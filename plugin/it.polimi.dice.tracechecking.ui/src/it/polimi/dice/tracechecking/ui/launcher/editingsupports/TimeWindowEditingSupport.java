...
public class TimeWindowEditingSupport extends EditingSupport {

	private final TableViewer viewer;
	private final CellEditor editor;
	private final DirtableTab tab;
	
	public TimeWindowEditingSupport(TableViewer viewer, DirtableTab tab) {
		super(viewer);
		this.viewer = viewer;
	...
	protected Object getValue(Object element) {
		return ((TopologyNodeFormula) element).getTimeWindow().toString();
	}
	...
	protected void setValue(Object element, Object userInputValue) {
		try {
			...
			((TopologyNodeFormula) element).setTimeWindow(value);
