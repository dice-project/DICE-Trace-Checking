...
public class TimeSubWindowEditingSupport extends EditingSupport {

	private final TableViewer viewer;
	private final CellEditor editor;
	private final DirtableTab tab;

	public TimeSubWindowEditingSupport(TableViewer viewer, DirtableTab tab) {
		super(viewer);
		this.viewer = viewer;
	...
	protected Object getValue(Object element) {
		return ((TopologyNodeFormula) element).getTimeSubWindow().toString();
	}
	...
	protected void setValue(Object element, Object userInputValue) {
		try {
			...
			((TopologyNodeFormula) element).setTimeSubWindow(value);
